...
class HalfFootballFieldPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRect(
      Rect.fromLTWH(
          penAreaLeft, penAreaTop.toDouble(), penAreaWidth, penAreaHeight),
      linePaint,
    );
    ...
    canvas.drawRect(
      Rect.fromLTWH(
          goalAreaLeft, goalAreaTop.toDouble(), goalAreaWidth, goalAreaHeight),
      linePaint,
    );
    ...
    final halfArcWidth = math.sqrt(
        math.pow(arcRadius, 2) - math.pow(penAreaBottom - penaltySpotY, 2));
    final startAngle =
        math.pi - math.asin((penAreaBottom - penaltySpotY) / arcRadius);
    ...
    final arcPath = Path()
      ...
      ..arcTo(Rect.fromCircle(center: arcCenter, radius: arcRadius), startAngle,
